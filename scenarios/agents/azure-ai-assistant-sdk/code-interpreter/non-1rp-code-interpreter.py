...
#
project_connection_string = "westus3.api.azureml.ms;921496dc-987f-410f-bd57-426eb2611356;shpeng-westus3-rg;project-demo-kxot"
...
with project_client:
    ...
    messages = project_client.agents.get_messages(thread_id=thread.id, message_id=message.id)
    print(f"Messages: {messages}")

    # get the most recent message from the assistant
    last_msg = message.get_last_text_message_by_sender("assistant")
    if last_msg:
