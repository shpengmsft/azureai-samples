...
project_endpoint = "https://shpengJeAcct1.services.ai.azure.com/api/projects/project1"
model_deployment_name = "dep-gpt-4o-mini"  # Change if you deployed a different model
